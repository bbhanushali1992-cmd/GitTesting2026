...
public class HelloAutomationExample {
...
System.out.println("Skill people can use the  programming language");
        System.out.println("I want to add the jenkins file to repositories automation");
              System.out.println("we are using simple cron expressions");
    }
}
